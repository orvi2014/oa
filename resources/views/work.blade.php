						...
						<div class="modal-dialog modal-dialog-centered">
							...
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title">ERP Softwaregit</h4>
								</div>
			...
			<div class="col-md-6 col-sm-6">
				<div class="fh5co-grid-work">
					<div class="work-holder">
						...
						<a href="#" class="inner-overlay inner-overlay-3"><i class="glyphicon glyphicon-plus"></i>Edit here</a>
					</div>
					<div class="desc">
						<span>
			...
			<div class="col-md-6 col-sm-6">
				<div class="fh5co-grid-work">
					<div class="work-holder">
						...
						<a href="#" class="inner-overlay inner-overlay-4"><i class="glyphicon glyphicon-plus"></i></a>
					</div>
					<div class="desc">
						<span>

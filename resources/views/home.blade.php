            ...
            <div class="row">
                <div class="col-md-4 animate-box">
                    ...
                    <ul class="contact-info">
						<li><i class="icon-location-pin"></i><p>Mirpur DOHS, Avenue 3</p></li>
                        <li><i class="icon-phone2"></i> <p>+880 168 3754716</p></li>
                        <li><i class="icon-mail"></i><p><a href="#">services.oabd@gmail.com </a></p></li>
                        <li><i class="icon-globe2"></i><p><a href="#">oabd.herokuapp.com</a></p></li>
                    </ul>
                </div>
